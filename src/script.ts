...
class Application extends PIXI.Application {
  ...
  constructor(public animationOptions) {
...
class Animator {
  ...
  filterPoint = new PIXI.Point();  
  zoomFilter = new PIXI.filters.ZoomBlurFilter(0, this.filterPoint, 0);  
  bulgePinchFilter = new PIXI.filters.BulgePinchFilter([0.5, 0.5], 600, -0.35);  
  bloomFilter = new PIXI.filters.AdvancedBloomFilter({ threshold: 1 }); 
  ...
  constructor(public app, public options) {    
...
class ZoomContainer extends PIXI.Container {
  ...
  filterArea = this.options.filterArea;
